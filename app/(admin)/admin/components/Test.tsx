...
const UserData = () => {
	...
	const setMacronutrientsFromTotalCalories = (totalCalories: number) => {
		...
		const totalMacros = {
			proteins: Number(proteins.toFixed(0)),
	...
	const setNewMacronutrientsFromTotalCalories = (age, height, weight, gender, goal, activity) => {
		...
		const totalUserChoices = (baseCalories + basedHeight + basedWeight + baseGoalAmount) * baseActivityAmount * basedAge
								...
								{editedUserData && (
									<>
										...
										<div className='settings__user-settings-item calories'>
											...
											<input
												className='settings__user-settings-data'
												onChange={e => setUserTotalCalories(Number(e.target.value))}>
										...
										<div className='settings__user-settings-item'>
											...
											<div className='settings__input-macro-container'>
												<input
													className='settings__user-settings-data'
													onChange={e => handleInputChange('userProteins', e.target.value)}>
													<span>P:</span>
													{`${editedUserData.userProteins}g`}
												</input>
												<input
													className='settings__user-settings-data'
													onChange={e => handleInputChange('userCarbs', e.target.value)}>
													<span>C:</span>
													{`${editedUserData.userCarbs}g`}
												</input>
												<input
													className='settings__user-settings-data'
													onChange={e => handleInputChange('userFats', e.target.value)}>
													<span>F:</span>
