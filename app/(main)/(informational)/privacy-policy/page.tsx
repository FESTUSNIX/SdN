	...
	return (
		<main className='wrapper grow'>
			<header className='mb-16 mt-12'>
				...
				<Muted className='mb-4'>Last updated: August 07, 2023</Muted>
				<p>
					...
					<List>
						...
						<li>
							<p>
								...
								or &quot;Our&quot; in this Agreement) refers to FESTUS CO., POLANDO.
							</p>
						</li>
						<li>
							<p>
						...
						<li>
							<p>
								<strong>Website</strong> refers to SDN, accessible from{' '}
								<Link
									className='font-medium hover:underline'
									href='localhost:3000'
			...
			<section className='mb-12'>
				...
				<article className='mb-4'>
					<H3 className='mb-2'>Retention of Your Personal Data</H3>
					<p>
				...
				<article className='mb-4'>
					<H3 className='mb-2'>Transfer of Your Personal Data</H3>
					<p>
				...
				<article className='mb-4'>
					<H3 className='mb-2'>Delete Your Personal Data</H3>
					<p>
				...
				<article className='mb-4'>
					<H3 className='mb-2'>Security of Your Personal Data</H3>
					<p>
			...
			<section className='mb-12'>
				...
				<List>
					<li>
						<p>By email: kontakt@sdn.pl</p>
					</li>
					<li>
						<p>By phone number: 123 456 789</p>
					</li>
				</List>
			</section>
		</main>
